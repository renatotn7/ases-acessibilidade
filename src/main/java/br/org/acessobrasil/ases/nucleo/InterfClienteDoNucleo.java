...
/**
 * Interface para Cliente de um núcleo
...
public interface InterfClienteDoNucleo {
	...
	/**
	 * O núcleo passa a lista de links da página que avaliou
	 */
	public void linksAchadosPeloNucleo(HashSet<String> links);
	
	/**
	 * O núcleo passa a lista de erros da página que avaliou
	 */
	...
	/**
	 * O núcleo passa a lista de avisos da página que avaliou
	 */
