...
/**
 * Parte do ScrollPaneCorrecao
 * @author Acessibilidade Brasil
 *
 */
public class TagTextFieldA extends JTextField {
	
	private static final long serialVersionUID = -950563813283070061L;
    private Tag tag;
    
    public TagTextFieldA(){}

    public TagTextFieldA(Tag tag) {
   	
    	if(tag.getTexto() != null) {
            this.setText(tag.getTexto());
        }
        this.tag = tag;
    }
