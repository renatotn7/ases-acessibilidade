...
/**
 * Filtro para arquivos do ASES, antigo silvinha 
 *
 */
public class SilvinhaFileFilter extends FileFilter {
	
	public String getDescription() {
		return (GERAL.ARQUIVOS_ASES);
	}
	...
	public boolean accept(File f) {
		...
		if (extension != null) {
			if (extension.equals(Extensions.silvinha)) {
				return true;
			} else {
				return false;
			}
