...
package br.org.acessobrasil.silvinha.util.lang;
...
public class TokenLang {
	...
	private void carregaPropriedades() throws IllegalAccessException, FileNotFoundException, IOException {
		...
		props = new PropertyLoader().loadProperty(this);
		String language = props.getProperty(PropertyLoader.SILVINHA_LANGUAGE);
		if (language == null) {
