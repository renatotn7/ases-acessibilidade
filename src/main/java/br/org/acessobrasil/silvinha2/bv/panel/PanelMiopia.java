 ...
 * 
 */
public class PanelMiopia extends JPanel implements ChangeListener {
	/**
	 * Serial default
	 */
	...
	private Miopia miopia;

	public PanelMiopia(Miopia miopia, String nome) {
		super(new BorderLayout());
		LabelNome lblNome = new LabelNome(nome);
		JPanel painelSlider = new JPanel(new GridLayout(2, 1));
		slider = new SlidebarLabel(TradPaineisBV.FOCO, JSlider.HORIZONTAL, 0, 30, 1);
		this.miopia = miopia;
	...
	public PanelMiopia(Miopia miopia) {
		super(new GridLayout(2, 1));
		// System.out.print("PanelHipermetropia(Hipermetropia
		// hipermetropia)()\n");
