 ...
 *
 */
public class PanelHipermetropia extends JPanel implements ChangeListener{
	/**
	 * Serial default 
	 */
	...
	private Hipermetropia hipermetropia;
	public PanelHipermetropia(Hipermetropia hipermetropia,String nome){
	...
	public PanelHipermetropia(Hipermetropia hipermetropia){
