...
public class SemVerde implements FiltroDeImagem  {

	public BufferedImage aplicaFiltro(BufferedImage bi) {
		//BufferedImage gray = new BufferedImage(bi.getWidth(), bi.getHeight(), BufferedImage.);
		//((Graphics2D) gray.getGraphics()).drawImage(bi, new AffineTransform(), null);
		//return gray;
	    ColorConvertOp op = new ColorConvertOp(ColorSpace.getInstance(ColorSpace.CS_GRAY), null);
	    BufferedImage grayImage = op.filter(bi, null);
