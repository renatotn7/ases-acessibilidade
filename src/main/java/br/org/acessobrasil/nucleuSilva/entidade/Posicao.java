...
/**
 * Classe que corresponde a localização, em linhas e colunas,
 * da tag HTML avaliada na página avaliada.
...
public final class Posicao {
     ...
     * @param posLinha Linha onde está a tag.
     * @param posCol Coluna onde está a tag.
     */
    public Posicao(final int posLinha, final int posCol) {
