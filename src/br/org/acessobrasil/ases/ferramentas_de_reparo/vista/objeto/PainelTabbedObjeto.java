 ...
 *
 */
public class PainelTabbedObjeto<PAINELFERR extends PainelObjeto> extends SuperPainelCentral implements ChangeListener, ActionListener   {
	/**
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command == "Procurar") {
			ferrEditavel.scrollPaneDescricao.buscar();
		}
	...
	private void adicionaPaineis(PAINELFERR ferrEditavel,
			PAINELFERR ferrNaoEditavel) {
		frameSilvinha.setJMenuBar(MenuSilvinha.criaMenuBar(frameSilvinha, this, miBtnSalvar, ferrEditavel.scrollPaneDescricao));
	...
	public void init(FrameSilvinha frameSilvinha){
		...
		this.frameSilvinha.setTitle(GERAL.TIT_CONT_ALT_TAG_OBJECT);
		editNaoEdit = new JTabbedPane();
		this.setBackground(frameSilvinha.corDefault);
		editNaoEdit.addChangeListener(this);
	}
	
	public PainelTabbedObjeto(FrameSilvinha frameSilvinha){
		super(new BorderLayout());
		ferrNaoEditavel =(PAINELFERR)new PainelObjeto(TxtBuffer.getContentOriginal(), PainelObjeto.CONTEUDO, frameSilvinha);
		ferrEditavel =(PAINELFERR)new PainelObjeto(TxtBuffer.getContent(), PainelObjeto.CONTEUDO,frameSilvinha);
		init(frameSilvinha);
		adicionaPaineis(ferrEditavel, ferrNaoEditavel);
	}
	
	public PainelTabbedObjeto(String conteudo, int conteudoOuArquivo, FrameSilvinha frameSilvinha){
		super(new BorderLayout());
		ferrNaoEditavel = (PAINELFERR)new PainelObjeto(TxtBuffer.getContentOriginal(), PainelObjeto.CONTEUDO, frameSilvinha);
		ferrEditavel =(PAINELFERR)new PainelObjeto(conteudo, PainelObjeto.CONTEUDO, frameSilvinha);
		init(frameSilvinha);
		adicionaPaineis(ferrEditavel, ferrNaoEditavel);
	}
