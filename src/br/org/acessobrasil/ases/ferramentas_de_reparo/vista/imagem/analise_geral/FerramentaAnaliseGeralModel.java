...
/**
 * Guarda as informações de onde está o erro 
 */
class FerramentaAnaliseGeralModel {
	/**
	 ...
	 */
	public FerramentaAnaliseGeralModel(final int posLinha, final int posCol, final String texto) {

		this.linha = posLinha;
		this.coluna = posCol;
		this.endereco=texto;
	}
	public FerramentaAnaliseGeralModel(final int posLinha, final int posCol) {

		this.linha = posLinha;
		this.coluna = posCol;
	}

	public FerramentaAnaliseGeralModel() {
	}
