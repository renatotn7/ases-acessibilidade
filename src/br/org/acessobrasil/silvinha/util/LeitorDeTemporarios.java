...
public class LeitorDeTemporarios {
	...
	public RelatorioDaUrl leiaTemporario(String path) {
		HashMap<String, Document> docs = LeitorDeRelatorio.lerRelatorios("temp/" + path);
		...
		if (docs != null) {
			...
			if (resumo.isGravaCompleto()) {
				...
				for (String key : docs.keySet()) {
					relatorio = RelatorioDaUrl.lerArquivoRelatorioEmXml(docs.get(key));
