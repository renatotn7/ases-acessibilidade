...
public class SilvinhaCtrl {
	...
	public SilvinhaCtrl(FrameSilvinha frameSilvinha) throws ClassNotFoundException, SQLException, IOException, IllegalAccessException{
		this.frameSilvinha=frameSilvinha;
		//log.info("Inicializando Silvinha");
	...
	public static void main(String args[]){
		...
		try {
			new SilvinhaCtrl(new FrameSilvinha());
